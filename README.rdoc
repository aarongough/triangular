...
Here's a quick code example of how to open an STL file, re-align it so it's coordinates are all in positive space, then cut a slice through it and save the slice outline as an SVG:
